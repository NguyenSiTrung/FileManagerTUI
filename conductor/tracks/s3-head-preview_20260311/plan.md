...
- [ ] Task 1: Add `s3_head_lines` to config system
...
- [ ] Task 1: Add S3 head preview state to `App`
...
- [ ] Task 2: Add `S3HeadComplete` event variant
...
- [ ] Task 3: Implement `App::spawn_s3_head()`
...
- [ ] Task 4: Implement `App::handle_s3_head_complete()`
...
- [ ] Task 1: Add `H` key handler in S3 mode
...
- [ ] Task 2: Update `update_preview()` S3 file branch
