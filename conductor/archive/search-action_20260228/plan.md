...
- [x] Task 1: Add SearchActionState and AppMode::SearchAction
...
- [x] Task 2: Modify search_confirm to transition to SearchAction mode
...
- [x] Task 1: Implement action methods on App
...
- [x] Task 1: Add handle_search_action_mode to handler.rs
...
- [x] Task 1: Create SearchActionWidget component
...
- [x] Task 2: Integrate widget into ui.rs
...
- [x] Task 1: Update help overlay and documentation
